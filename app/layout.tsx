...
export const metadata: Metadata = {
  ...
  description: "Rezervujte dopravu to/from Prague Airport in advance. Fixed price, professional driveri, sledování letu. Sedan from €29, minivan od €36. Bez příplatků za delay.",
