      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="md:col-span-1">
            <div className="mb-4">
              <img src="/logo-en.png" alt="Transfer Prague Car" loading="lazy" style={{ height: "40px", objectFit: "contain", filter: "brightness(0) invert(1)" }} />
            </div>
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "8px" }}>
              {[
                ...
                { label: "How to get from the airport", href: "/how-to-get-from-the-airport" },
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,.08)", paddingTop: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: "12px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              <img src="/logo-en.png" alt="Transfer Prague Car" loading="lazy" style={{ height: "28px", objectFit: "contain", filter: "brightness(0) invert(1)", opacity: 0.6 }} />
              <div>
